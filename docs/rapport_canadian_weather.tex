...
Les largeurs de bande $\sigma_f$ et $\sigma_s$ sont fixées par la règle de la
médiane \cite{jaakkola1999}. Le seul paramètre libre est $\alpha$,
...
la grille $\{0, 0.05, \ldots, 1\}^2$ ($21 \times 21$ points), puis on applique \textbf{PAM}
...
$21 \times 21 = 441$ exécutions de PAM.

\subsection{Stratégie C : $\DK(\alpha)$ + PAM}

On construit $\DK(\alpha)$ pour chaque $\alpha \in \{0, 0.05, \ldots, 1\}$, puis
