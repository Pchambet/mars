...
\medskip
Ces trois strat\'egies ont \'et\'e \textbf{impl\'ement\'ees et compar\'ees} sur trois jeux de donn\'ees labellis\'es (Canadian Weather, Growth, Tecator). Les r\'esultats montrent que (1)~les d\'eriv\'ees sont syst\'ematiquement informatives ($\alpha_{\text{optimal}} \geq 0.6$ sur les trois jeux), et que (2)~le verrou principal est le \textbf{crit\`ere de s\'election} du couple $(\alpha, \omega)$ en contexte non supervis\'e. Le rapport de synth\`ese d\'etaille ces r\'esultats.
