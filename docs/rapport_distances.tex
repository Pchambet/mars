...
\begin{itemize}[nosep]
  ...
  \item Le grid search est exact sur la grille mais ne teste pas les valeurs
    entre les pas (ici $0{,}05$ sur $[0,1]$). Un pas plus fin reste possible mais
    coûteux.
\end{itemize}
