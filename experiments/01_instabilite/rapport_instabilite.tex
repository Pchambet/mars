...
évaluer l'ARI une fois $k$ choisi. Des \textbf{données simulées} et des
\textbf{études sur données simulées} complètent le rapport : données artificielles
où le vrai $k$ est connu, pour voir si la méthode se comporte bien quand on
connaît la réponse. Pour gagner du temps, ces calculs utilisent
une grille plus lâche ($6\times6$) et moins de répétitions bootstrap ($B=60$) que
les quatre jeux réels ($21\times21$, $B=150$).
\end{abstract}
