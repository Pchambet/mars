...
#   setwd("/chemin/vers/mars")
#   source("experiments/01_stabilite/run_all_stability.R")
#
# Ou en ligne de commande :
#   cd /chemin/vers/mars && Rscript -e 'source("experiments/01_stabilite/run_all_stability.R")'
#
# ============================================================================
...
for (d in DATASETS) {
  DATASET <- d
  source("experiments/01_stabilite/run_stabilite.R", local = FALSE)
}

cat("\n══════════════════════════════════════════════════════════════════════\n")
cat("  Exécution terminée. Résultats dans experiments/01_stabilite/results/\n")
cat("  Lancer : source(\"experiments/01_stabilite/analyse_stabilite.R\")\n")
cat("══════════════════════════════════════════════════════════════════════\n\n")
